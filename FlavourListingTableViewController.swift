//
//  FlavourListingTableViewController.swift
...
class FlavourListingTableViewController: UITableViewController,UINavigationControllerDelegate {

    
    var listCakeflavour = [String]()
    var listprice = [Float]()
    var numberOfRows = 0
    @IBOutlet var CakeFlavour: UITableView!
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("flavourdisplay", forIndexPath: indexPath)
