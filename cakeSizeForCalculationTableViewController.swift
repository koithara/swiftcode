//
//  cakeSizeForCalculationTableViewController.swift
...
class cakeSizeForCalculationTableViewController: UITableViewController,UINavigationControllerDelegate {
    var listCakeSize = [Int]()
    var listCakeShape = [String]()
    var listNumberOfServings = [Int]()
    var numberOfRows = 0
    
    @IBOutlet var cakeSizeforcalculation: UITableView!
    ...
    func getCakeProperties()
    {
        ...
        cakeQuery.findObjectsInBackgroundWithBlock {(Cakes, error) -> Void in
            ...
            else
            {
                ...
                self.cakeSizeforcalculation.reloadData()
    ...
    override func numberOfSectionsInTableView(tableView: UITableView) -> Int {
        // #warng Incomplete implementation, return the number of sections
        return 1
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cakesizecell", forIndexPath: indexPath)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "getCakeproperties"){
            let toeditcakesize = segue.destinationViewController as! CostCalculatorViewController
            let toeditcakeshape = segue.destinationViewController as! CostCalculatorViewController
            let toeditcakenumber = segue.destinationViewController as! CostCalculatorViewController
            let indexPath = (cakeSizeforcalculation.indexPathForCell(sender as! UITableViewCell))!.row
